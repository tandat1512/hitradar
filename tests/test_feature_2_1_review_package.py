...
PREP_DIR = ROOT / '7.ML/7.3.data_intake'
PACKAGE_FILE = OUTPUT_DIR / 'BAO_CAO_NGHIEM_THU_FEATURE_2_1.md'
...
def test_closure_fields_have_direct_evidence():
    text = PACKAGE_FILE.read_text(encoding='utf-8')
    assert "feature_2_1_closure_gate.json" in text
...
def test_package_generator_idempotent():
    ...
    subprocess.check_call(["python", "9.SCRIPTS/build_feature_2_1_review_package.py"], cwd=ROOT, env={**os.environ, 'FROZEN_TIME': '2026-07-18T10:00:00+00:00'})
