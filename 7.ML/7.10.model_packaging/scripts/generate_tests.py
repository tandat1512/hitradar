...
def test_gate():
    path = os.path.join(r"<PROJECT_ROOT>/7.ML/7.10.model_packaging", "validation", "feature_2_6_handoff_gate_validation.json")
...
def test_input_contract():
    path = os.path.join(r"<PROJECT_ROOT>/7.ML/7.10.model_packaging", "validation", "feature_2_7_input_validation.json")
    assert os.path.exists(path)
    data = json.load(open(path, 'r', encoding='utf-8'))
    assert data["is_valid"] == True
""",
...
def test_dimensions():
    path = os.path.join(r"<PROJECT_ROOT>/7.ML/7.10.model_packaging", "manifests", "feature_2_7_dimension_contract.json")
    assert os.path.exists(path)
    data = json.load(open(path, 'r', encoding='utf-8'))
...
def test_loadback():
    path = os.path.join(r"<PROJECT_ROOT>/7.ML/7.10.model_packaging", "validation", "packaged_artifact_load_validation.json")
    assert os.path.exists(path)
    data = json.load(open(path, 'r', encoding='utf-8'))
...
def test_component_equivalence():
    path = os.path.join(r"<PROJECT_ROOT>/7.ML/7.10.model_packaging", "validation", "packaged_component_equivalence_validation.json")
    assert os.path.exists(path)
    data = json.load(open(path, 'r', encoding='utf-8'))
...
def test_no_refit():
    path = os.path.join(r"<PROJECT_ROOT>/7.ML/7.10.model_packaging", "validation", "feature_2_7_no_refit_validation.json")
    assert os.path.exists(path)
    data = json.load(open(path, 'r', encoding='utf-8'))
    assert data["is_valid"] == True
...
def test_phase_1_governance():
    path = os.path.join(r"<PROJECT_ROOT>/7.ML/7.10.model_packaging", "checkpoints", "feature_2_7_phase_1_checkpoint.json")
    assert os.path.exists(path)
    data = json.load(open(path, 'r', encoding='utf-8'))
